export function SideBar() {
    const items = ["Home","Orders","Products","Delivery","Marketing","Analytics","Payouts","Discounts","Audience","Appearence","Plugins"];

    return (
        <>
            <div className="ps-5 pe-5 w-3xs bg-blue-950 text-blue-50 font-medium h-screen hidden">
                <div className="flex justify-between pt-4">
                    <div className="flex">
                        <div><img src="" alt="" /></div>
                        <div>
                            <div>Nishyan</div>
                            <div><a href="">visitstore</a></div>
                        </div>
                    </div>
                    <div>
